...
.method public static addImage(Landroid/content/Context;Ljava/lang/String;JLandroid/location/Location;I[BZIIZZ)Landroid/net/Uri;
    ...
    .line 13
    invoke-static {v15, v9}, Lcom/android/camera/storage/Storage;->requireRecordExists(Landroid/content/Context;Landroid/net/Uri;)V
...
.method public static insertToMediaStore(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZ)Landroid/net/Uri;
    ...
    const-string v8, "insertToMediaStore: title = %s , displayName = %s , size = %d , filePath = %s"

    .line 3
    invoke-static {v4, v8, v5}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 7
    invoke-virtual {v4, v2, p5}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Double;)V
    ...
    invoke-static {p0, v6, v3}, Lcom/android/camera/storage/Storage;->getMediaUri(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    const-string v7, "insert to media store: title "
    ...
    .line 22
    invoke-static {p0, v3}, Lcom/xiaomi/camera/parallelservice/util/ParallelUtil;->getThumbnailFilePathFor(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v5, v6, v3, v1}, Lcom/xiaomi/camera/parallelservice/util/ParallelUtil;->insertToParallelTaskProvider(Landroid/content/Context;JLjava/lang/String;Ljava/lang/String;)V
    ...
    const-string v7, "insert to parallel store: filePath "
...
.method public static isUseDocumentMode()Z
    ...
    invoke-virtual {v0}, LOooO00o/OooO0Oo/OooO00o/OooO00o;->oOooo0o()Z
...
.method public static openOutputStream(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Ljava/io/OutputStream;
    ...
    .line 2
    invoke-static {p1, p0}, Lcom/android/camera/FileCompat;->getFileOutputStream(Ljava/lang/String;Z)Ljava/io/OutputStream;
...
.method public static requireRecordExists(Landroid/content/Context;Landroid/net/Uri;)V
    .locals 3
    ...
    const-string/jumbo v0, "requireRecordExists: query operation failed"
...
.method public static saveImageToExternalStorage(Landroid/content/Context;[BLjava/lang/String;Landroid/net/Uri;)Z
    ...
    .line 15
    :cond_2
    sget v1, Lcom/android/camera/storage/Storage;->MAX_WRITE_RETRY:I

    goto :goto_3

    .line 16
    :cond_3
    sget v3, Lcom/android/camera/storage/Storage;->MAX_WRITE_RETRY:I
...
.method public static updateImage(Landroid/content/Context;[BZZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;)Landroid/net/Uri;
    ...
    const-string v9, "media provider path match!"
    ...
    const-string/jumbo v7, "updateImage:  tmpPath = "
    ...
    invoke-static {v9, v13, v0}, Lcom/android/camera/log/Log;->k(ILjava/lang/String;Ljava/lang/String;)I
    ...
    :try_start_2
    invoke-static {v8, v9}, Lcom/android/camera/FileCompat;->getFileOutputStream(Ljava/lang/String;Z)Ljava/io/OutputStream;
    ...
    .line 19
    invoke-virtual {v15, v0, v2, v6}, Ljava/io/BufferedOutputStream;->write([BII)V
    :try_end_6
    ...
    :try_start_c
    invoke-virtual {v2, v15}, Ljava/lang/Throwable;->addSuppressed(Ljava/lang/Throwable;)V
    ...
    .line 27
    :goto_f
    invoke-static {v0, v8}, Lcom/android/camera/storage/Storage;->dumpExceptionEnv(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    invoke-static {v2, v6, v0}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    .line 31
    new-instance v2, Lcom/android/camera/storage/Storage$2;

    invoke-direct {v2, v1}, Lcom/android/camera/storage/Storage$2;-><init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "updateImage  writeFile cost %s ms"

    invoke-static {v0, v2, v6}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    const-string v13, "Exception when delete old file "
    ...
    invoke-static {v7, v9, v0}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string v5, "fail to rename "

    if-eqz v3, :cond_18

    .line 70
    invoke-static {v14, v8}, Lcom/android/camera/storage/Storage;->renameSdcardFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 73
    invoke-static {v14}, Lcom/android/camera/storage/Storage;->deleteSdcardFile(Ljava/lang/String;)Z
    ...
    .line 76
    :goto_19
    invoke-static {v14}, Lcom/android/camera/FileCompat;->removeDocumentFileForPath(Ljava/lang/String;)V
