...
.field public final mSaverCallbackWeakReference:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public varargs doInBackground([Ljava/lang/Void;)Lcom/android/camera/Thumbnail;
    ...
    const-class v3, Lcom/android/camera/module/SaveOutputImageTask;
    ...
    .line 16
    :cond_1
    sget-object v1, Lcom/android/camera/Util;->sIsDumpOrigJpg:Ljava/lang/Boolean;
    ...
    invoke-interface {v0, v2, v3, v4}, Lcom/android/camera/storage/SaverCallback;->notifyNewMediaData(Landroid/net/Uri;Ljava/lang/String;I)V
...
.method public onPostExecute(Lcom/android/camera/Thumbnail;)V
    ...
    .line 5
    iget-object p1, p0, Lcom/android/camera/module/SaveOutputImageTask;->mSaverCallbackWeakReference:Ljava/lang/ref/WeakReference;

    invoke-virtual {p1}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/android/camera/storage/SaverCallback;

    invoke-interface {p1}, Lcom/android/camera/storage/SaverCallback;->postHideThumbnailProgressing()V
    ...
    const-string/jumbo v2, "onPostExecute thumbnail = "
