...
.method public static synthetic OooO00o(Lcom/android/camera/module/Camera2Module;Lcom/android/camera/protocol/ModeProtocol$MainContentProtocol;)V
    ...
    .line 5
    invoke-interface {p1, p0}, Lcom/android/camera/protocol/ModeProtocol$IndicatorProtocol;->clearFocusView(I)V
...
.method public static synthetic OooO00o(Lcom/android/camera/protocol/ModeProtocol$CameraAction;)V
    ...
    .line 6
    invoke-interface {p0, v0}, Lcom/android/camera/protocol/ModeProtocol$CameraAction;->onShutterButtonClick(I)Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-interface {p1, v7}, Lcom/android/camera/module/common/ModuleCameraManagerInterface;->setCameraState(I)V
    ...
    .line 13
    :pswitch_3
    invoke-static {}, Lcom/android/camera/protocol/ModeProtocol$CameraAction;->impl()Ljava/util/Optional;

    move-result-object p1

    sget-object v0, LOooO00o/OooO0O0/OooO00o/OooooOo/o000Ooo0/OooO0O0;->OooO00o:LOooO00o/OooO0O0/OooO00o/OooooOo/o000Ooo0/OooO0O0;
    ...
    .line 17
    invoke-virtual {v0, v4, v7}, Lcom/android/camera/module/Camera2Module;->showOrHideLoadingProgress(ZZ)V
    ...
    invoke-direct {v1, v0}, LOooO00o/OooO0O0/OooO00o/OooooOo/o000Ooo0/OooO0OO;-><init>(Lcom/android/camera/module/Camera2Module;)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera/module/Camera2Module;->onShutterButtonClick(I)Z
    ...
    .line 34
    invoke-static {v8, p1}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    const-wide/16 v1, 0x0

    .line 35
    invoke-virtual {v0, v4, v1, v2, v4}, Lcom/android/camera/module/Camera2Module;->onPictureTakenFinished(ZJI)V
    ...
    invoke-interface {p1, v7}, Lcom/android/camera/module/common/ModuleCameraManagerInterface;->setOpenCameraFail(Z)V
    ...
    .line 41
    :cond_6
    instance-of p1, v0, Lcom/android/camera/features/mode/capture/CaptureModule;
    ...
    invoke-virtual {p1}, Lcom/android/camera/module/image/LiveMediaManager;->startVideoRecording()V
    ...
    .line 45
    iget-boolean p1, v0, Lcom/android/camera/module/Camera2Module;->mShutterReturned:Z
    ...
    :cond_9
    invoke-virtual {v0, v1, v7, v4, v7}, Lcom/android/camera/customization/FlashHalo;->reConfigScreenHaloRequest(IZZZ)V
    ...
    :cond_c
    invoke-virtual {v0, v1, v4}, Lcom/android/camera/module/Camera2Module;->handleUpdateFaceView(ZZ)V
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/camera/module/Camera2Module;->setOrientation(II)V
