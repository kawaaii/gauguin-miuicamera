...
.method private calculateAndRemoveTimeoutTask(J)V
    ...
    iget-wide v6, v5, Lcom/xiaomi/camera/core/ImageProcessor$TaskRecord;->timestamp:J

    invoke-interface {v4, v6, v7}, Lcom/xiaomi/camera/core/ImageProcessor$ImageProcessorStatusCallback;->getParallelTaskData(J)Lcom/xiaomi/camera/core/ParallelTaskData;
    ...
    iget-wide v7, v5, Lcom/xiaomi/camera/core/ImageProcessor$TaskRecord;->timestamp:J

    const-string v5, "engine timeout"

    invoke-interface {v6, v7, v8, v5}, Lcom/xiaomi/camera/core/ImageProcessor$ImageProcessorStatusCallback;->onImageProcessFailed(JLjava/lang/String;)V
...
.method private processImage()V
    ...
    const-string v2, "processImage: task session has died"
...
.method public dispatchTask(Lcom/xiaomi/camera/core/TaskData;)I
    ...
    const-string v0, "dispatchTask: task session has died"
    ...
    const-string v2, "dispatchTask: skip. taskNum = "
    ...
    const-string v0, "dispatchTask: X"
...
.method public onPreProcessImage(Lcom/xiaomi/camera/core/TaskData;)V
    ...
    const-string v0, "onPreProcessImage: X"
...
.method public onProcessImageDone(J)V
    ...
    const-string p2, "onProcessImageDone: X"
...
.method public setTaskSession(Lcom/xiaomi/engine/TaskSession;)V
    ...
    const-string v0, "setTaskSession: worker thread has died"
...
.method public setTaskSession2(Lcom/xiaomi/camera/core/ImageProcessor$TaskSessionWrapper;)V
    ...
    const-string v0, "setTaskSession2: worker thread has died"
...
.method public startWork()V
    ...
    .line 2
    new-instance v0, Lcom/xiaomi/camera/core/ImageProcessor$WorkerHandler;
    ...
    invoke-direct {v0, v1, p0}, Lcom/xiaomi/camera/core/ImageProcessor$WorkerHandler;-><init>(Landroid/os/Looper;Lcom/xiaomi/camera/core/ImageProcessor;)V
